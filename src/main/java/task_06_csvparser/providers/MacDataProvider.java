...
/**
 * Data provider for Mac operation system
 */
public class MacDataProvider extends AbstractDataProvider {

    @Override
    protected void initFilePaths() {
        System.out.println("Using MacOS path to file construction");
        String USER_DIRECTORY = System.getProperty("user.dir");
        String FILES_PATH = "/src/main/java/task_06_csvparser/files";
